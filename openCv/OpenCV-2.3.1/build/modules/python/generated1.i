...
{"CalcEMD2", (PyCFunction)pycvCalcEMD2, METH_KEYWORDS, "CalcEMD2(signature1, signature2, distance_type [, distance_func [, cost_matrix [, flow [, lower_bound [, userdata]]]]]) -> None"},
...
{"CalcOpticalFlowPyrLK", pycvCalcOpticalFlowPyrLK, METH_VARARGS, "CalcOpticalFlowPyrLK(prev, curr, prevPyr, currPyr, prevFeatures, winSize, level, criteria, flags, guesses) -> currFeatures,status,track_error"},
...
{"CreateMemStorage", pycvCreateMemStorage, METH_VARARGS, "CreateMemStorage(blockSize) -> CvMemStorage"},
...
{"FindContours", (PyCFunction)pycvFindContours, METH_KEYWORDS, "FindContours(image, storage [, mode [, method [, offset]]]) -> None"},
...
{"GetDims", pycvGetDims, METH_VARARGS, "GetDims(arr) -> None"},
...
{"GetImage", pycvGetImage, METH_VARARGS, "GetImage(arr) -> None"},
...
{"GetMat", (PyCFunction)pycvGetMat, METH_KEYWORDS, "GetMat(arr [, allowND]) -> None"},
...
{"Reshape", pycvReshape, METH_VARARGS, "Reshape(arr, newCn, newRows) -> None"},
{"ReshapeMatND", pycvReshapeMatND, METH_VARARGS, "ReshapeMatND(arr, newCn, newDims) -> None"},
...
{"WaitKey", (PyCFunction)pycvWaitKey, METH_KEYWORDS, "WaitKey( [, delay]) -> None"},
