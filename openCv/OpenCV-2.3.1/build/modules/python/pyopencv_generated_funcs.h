...
static PyObject* pyopencv_CvEM_CvEM(PyObject* , PyObject* args, PyObject* kw)
{
    {
    pyopencv_CvEM_t* self = 0;

    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        self = PyObject_NEW(pyopencv_CvEM_t, &pyopencv_CvEM_Type);
        if(self) ERRWRAP2(self->v = new CvEM());
        return (PyObject*)self;
    }
    }
    PyErr_Clear();
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|OO:CvEM", (char**)keywords, &pyobj_samples, &pyobj_sampleIdx, &pyobj_params) &&
        pyopencv_to(pyobj_samples, samples) &&
        pyopencv_to(pyobj_sampleIdx, sampleIdx) &&
        pyopencv_to(pyobj_params, params) )
    {
        self = PyObject_NEW(pyopencv_CvEM_t, &pyopencv_CvEM_Type);
        if(self) ERRWRAP2(self->v = new CvEM(samples, sampleIdx, params));
        return (PyObject*)self;
    }
    }
...
static PyObject* pyopencv_FileStorage_FileStorage(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    {
        self = PyObject_NEW(pyopencv_FileStorage_t, &pyopencv_FileStorage_Type);
        if(self) ERRWRAP2(self->v = new cv::FileStorage(filename, flags, encoding));
        return (PyObject*)self;
    }
    }
...
static PyObject* pyopencv_GaussianBlur(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "src", "ksize", "sigma1", "dst", "sigma2", "borderType", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOd|Odi:GaussianBlur", (char**)keywords, &pyobj_src, &pyobj_ksize, &sigma1, &pyobj_dst, &sigma2, &borderType) &&
        pyopencv_to(pyobj_src, src) &&
        pyopencv_to(pyobj_dst, dst) &&
        pyopencv_to(pyobj_ksize, ksize) )
    {
        ERRWRAP2( cv::GaussianBlur(src, dst, ksize, sigma1, sigma2, borderType));
...
static PyObject* pyopencv_MSER_MSER(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        ...
        if(self) ERRWRAP2(self->v = new cv::MSER());
        return (PyObject*)self;
    }
    }
    PyErr_Clear();
    ...
    int _min_area=0;
    int _max_area=0;
    double _max_variation=0;
    double _min_diversity=0;
    int _max_evolution=0;
    double _area_threshold=0;
    double _min_margin=0;
    int _edge_blur_size=0;
...
static PyObject* pyopencv_PCACompute(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "data", "mean", "mean", "eigenvectors", "maxComponents", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OO|OOi:PCACompute", (char**)keywords, &pyobj_data, &pyobj_mean, &pyobj_mean, &pyobj_eigenvectors, &maxComponents) &&
        pyopencv_to(pyobj_data, data) &&
        pyopencv_to(pyobj_mean, mean) &&
        pyopencv_to(pyobj_eigenvectors, eigenvectors) )
    {
...
static PyObject* pyopencv_SURF_SURF(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "_hessianThreshold", "_nOctaves", "_nOctaveLayers", "_extended", "_upright", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "d|iibb:SURF", (char**)keywords, &_hessianThreshold, &_nOctaves, &_nOctaveLayers, &_extended, &_upright) )
    {
        self = PyObject_NEW(pyopencv_SURF_t, &pyopencv_SURF_Type);
        if(self) ERRWRAP2(self->v = new cv::SURF(_hessianThreshold, _nOctaves, _nOctaveLayers, _extended, _upright));
        return (PyObject*)self;
    }
    }
...
static PyObject* pyopencv_StarDetector_StarDetector(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        ...
        if(self) ERRWRAP2(self->v = new cv::StarDetector());
        return (PyObject*)self;
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_calcOpticalFlowFarneback(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "prev", "next", "flow", "pyr_scale", "levels", "winsize", "iterations", "poly_n", "poly_sigma", "flags", "flow", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOdiiiidi|O:calcOpticalFlowFarneback", (char**)keywords, &pyobj_prev, &pyobj_next, &pyobj_flow, &pyr_scale, &levels, &winsize, &iterations, &poly_n, &poly_sigma, &flags, &pyobj_flow) &&
...
static PyObject* pyopencv_calcOpticalFlowPyrLK(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "prevImg", "nextImg", "prevPts", "nextPts", "nextPts", "status", "err", "winSize", "maxLevel", "criteria", "derivLambda", "flags", "minEigThreshold", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOO|OOOOiOdid:calcOpticalFlowPyrLK", (char**)keywords, &pyobj_prevImg, &pyobj_nextImg, &pyobj_prevPts, &pyobj_nextPts, &pyobj_nextPts, &pyobj_status, &pyobj_err, &pyobj_winSize, &maxLevel, &pyobj_criteria, &derivLambda, &flags, &minEigThreshold) &&
        ...
        pyopencv_to(pyobj_criteria, criteria) )
    {
        ERRWRAP2( cv::calcOpticalFlowPyrLK(prevImg, nextImg, prevPts, nextPts, status, err, winSize, maxLevel, criteria, derivLambda, flags, minEigThreshold));
...
static PyObject* pyopencv_calibrateCamera(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "objectPoints", "imagePoints", "imageSize", "cameraMatrix", "distCoeffs", "cameraMatrix", "distCoeffs", "rvecs", "tvecs", "flags", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOOO|OOOOi:calibrateCamera", (char**)keywords, &pyobj_objectPoints, &pyobj_imagePoints, &pyobj_imageSize, &pyobj_cameraMatrix, &pyobj_distCoeffs, &pyobj_cameraMatrix, &pyobj_distCoeffs, &pyobj_rvecs, &pyobj_tvecs, &flags) &&
    ...
    {
        ERRWRAP2( retval = cv::calibrateCamera(objectPoints, imagePoints, imageSize, cameraMatrix, distCoeffs, rvecs, tvecs, flags));
...
static PyObject* pyopencv_checkRange(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    {
        ERRWRAP2( retval = cv::checkRange(a, quiet, &pt, minVal, maxVal));
        return Py_BuildValue("(NN)", pyopencv_from(retval), pyopencv_from(pt));
    }
...
static PyObject* pyopencv_distanceTransform(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "src", "distanceType", "maskSize", "dst", "labels", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "Oii|OO:distanceTransform", (char**)keywords, &pyobj_src, &distanceType, &maskSize, &pyobj_dst, &pyobj_labels) &&
        pyopencv_to(pyobj_src, src) &&
        pyopencv_to(pyobj_dst, dst) &&
        pyopencv_to(pyobj_labels, labels) )
    {
        ERRWRAP2( cv::distanceTransform(src, dst, labels, distanceType, maskSize));
...
{
    int retval;
    PyObject* pyobj__from = NULL;
    Mat _from;
    PyObject* pyobj__to = NULL;
    Mat _to;
    PyObject* pyobj__out = NULL;
    Mat _out;
    PyObject* pyobj__inliers = NULL;
    Mat _inliers;
    double param1=3;
    double param2=0.99;

    const char* keywords[] = { "_from", "_to", "_out", "_inliers", "param1", "param2", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OO|OOdd:estimateAffine3D", (char**)keywords, &pyobj__from, &pyobj__to, &pyobj__out, &pyobj__inliers, &param1, &param2) &&
        pyopencv_to(pyobj__from, _from) &&
        pyopencv_to(pyobj__to, _to) &&
        pyopencv_to(pyobj__out, _out) &&
        pyopencv_to(pyobj__inliers, _inliers) )
    {
        ERRWRAP2( retval = cv::estimateAffine3D(_from, _to, _out, _inliers, param1, param2));
        return Py_BuildValue("(NNN)", pyopencv_from(retval), pyopencv_from(_out), pyopencv_from(_inliers));
    }
...
static PyObject* pyopencv_imencode(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "ext", "img", "buf", "params", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOO|O:imencode", (char**)keywords, &pyobj_ext, &pyobj_img, &pyobj_buf, &pyobj_params) &&
...
static PyObject* pyopencv_inpaint(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    PyObject* pyobj_dst = NULL;
    Mat dst;
    double inpaintRange=0;
    int flags=0;

    const char* keywords[] = { "src", "inpaintMask", "inpaintRange", "flags", "dst", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOdi|O:inpaint", (char**)keywords, &pyobj_src, &pyobj_inpaintMask, &inpaintRange, &flags, &pyobj_dst) &&
        pyopencv_to(pyobj_src, src) &&
        pyopencv_to(pyobj_inpaintMask, inpaintMask) &&
        pyopencv_to(pyobj_dst, dst) )
    {
        ERRWRAP2( cv::inpaint(src, inpaintMask, dst, inpaintRange, flags));
        return pyopencv_from(dst);
    }
...
static PyObject* pyopencv_kmeans(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "data", "K", "bestLabels", "criteria", "attempts", "flags", "bestLabels", "centers", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OiOOii|OO:kmeans", (char**)keywords, &pyobj_data, &K, &pyobj_bestLabels, &pyobj_criteria, &attempts, &flags, &pyobj_bestLabels, &pyobj_centers) &&
        pyopencv_to(pyobj_data, data) &&
...
static PyObject* pyopencv_pyrDown(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "src", "dst", "dstsize", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|OO:pyrDown", (char**)keywords, &pyobj_src, &pyobj_dst, &pyobj_dstsize) &&
        pyopencv_to(pyobj_src, src) &&
        pyopencv_to(pyobj_dst, dst) &&
        pyopencv_to(pyobj_dstsize, dstsize) )
    {
        ERRWRAP2( cv::pyrDown(src, dst, dstsize));
        return pyopencv_from(dst);
    }
...
static PyObject* pyopencv_pyrUp(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "src", "dst", "dstsize", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|OO:pyrUp", (char**)keywords, &pyobj_src, &pyobj_dst, &pyobj_dstsize) &&
        pyopencv_to(pyobj_src, src) &&
        pyopencv_to(pyobj_dst, dst) &&
        pyopencv_to(pyobj_dstsize, dstsize) )
    {
        ERRWRAP2( cv::pyrUp(src, dst, dstsize));
        return pyopencv_from(dst);
    }
...
static PyObject* pyopencv_solvePnP(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOO|OOb:solvePnP", (char**)keywords, &pyobj_objectPoints, &pyobj_imagePoints, &pyobj_cameraMatrix, &pyobj_distCoeffs, &pyobj_rvec, &pyobj_tvec, &useExtrinsicGuess) &&
        pyopencv_to(pyobj_objectPoints, objectPoints) &&
        pyopencv_to(pyobj_imagePoints, imagePoints) &&
        pyopencv_to(pyobj_cameraMatrix, cameraMatrix) &&
        pyopencv_to(pyobj_distCoeffs, distCoeffs) &&
        ...
        pyopencv_to(pyobj_tvec, tvec) )
    {
        ERRWRAP2( cv::solvePnP(objectPoints, imagePoints, cameraMatrix, distCoeffs, rvec, tvec, useExtrinsicGuess));
...
static PyObject* pyopencv_solvePnPRansac(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "objectPoints", "imagePoints", "cameraMatrix", "distCoeffs", "rvec", "tvec", "useExtrinsicGuess", "iterationsCount", "reprojectionError", "minInliersCount", "inliers", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOO|OObifiO:solvePnPRansac", (char**)keywords, &pyobj_objectPoints, &pyobj_imagePoints, &pyobj_cameraMatrix, &pyobj_distCoeffs, &pyobj_rvec, &pyobj_tvec, &useExtrinsicGuess, &iterationsCount, &reprojectionError, &minInliersCount, &pyobj_inliers) &&
        pyopencv_to(pyobj_objectPoints, objectPoints) &&
        pyopencv_to(pyobj_imagePoints, imagePoints) &&
        pyopencv_to(pyobj_cameraMatrix, cameraMatrix) &&
        pyopencv_to(pyobj_distCoeffs, distCoeffs) &&
    ...
    {
        ERRWRAP2( cv::solvePnPRansac(objectPoints, imagePoints, cameraMatrix, distCoeffs, rvec, tvec, useExtrinsicGuess, iterationsCount, reprojectionError, minInliersCount, inliers));
...
static PyObject* pyopencv_stereoCalibrate(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "objectPoints", "imagePoints1", "imagePoints2", "cameraMatrix1", "distCoeffs1", "cameraMatrix2", "distCoeffs2", "imageSize", "cameraMatrix1", "distCoeffs1", "cameraMatrix2", "distCoeffs2", "R", "T", "E", "F", "criteria", "flags", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOOOOOO|OOOOOOOOOi:stereoCalibrate", (char**)keywords, &pyobj_objectPoints, &pyobj_imagePoints1, &pyobj_imagePoints2, &pyobj_cameraMatrix1, &pyobj_distCoeffs1, &pyobj_cameraMatrix2, &pyobj_distCoeffs2, &pyobj_imageSize, &pyobj_cameraMatrix1, &pyobj_distCoeffs1, &pyobj_cameraMatrix2, &pyobj_distCoeffs2, &pyobj_R, &pyobj_T, &pyobj_E, &pyobj_F, &pyobj_criteria, &flags) &&
        pyopencv_to(pyobj_objectPoints, objectPoints) &&
