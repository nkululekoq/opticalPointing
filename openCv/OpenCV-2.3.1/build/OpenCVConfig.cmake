...
SET(OpenCV_INCLUDE_DIRS "/home/cbassuser/avnOpticalPointing/OpenCV-2.3.1/build" "/home/cbassuser/avnOpticalPointing/OpenCV-2.3.1/include" "/home/cbassuser/avnOpticalPointing/OpenCV-2.3.1/include/opencv")
...
SET(OpenCV_LIB_DIR /home/cbassuser/avnOpticalPointing/OpenCV-2.3.1/build/lib)
...
# ==============================================================
if(NOT "/home/cbassuser/avnOpticalPointing/OpenCV-2.3.1" STREQUAL  "")
    foreach(__CVLIB ${OpenCV_LIB_COMPONENTS})
        # We only need the "core",... part here: "opencv_core" -> "core"
        STRING(REGEX REPLACE "opencv_(.*)" "\\1" __MODNAME ${__CVLIB})
        INCLUDE_DIRECTORIES("/home/cbassuser/avnOpticalPointing/OpenCV-2.3.1/modules/${__MODNAME}/include")
    endforeach()
endif()
...
IF (NOT OpenCV_SHARED)
    ...
    LINK_DIRECTORIES("/home/cbassuser/avnOpticalPointing/OpenCV-2.3.1/build/3rdparty/lib")
